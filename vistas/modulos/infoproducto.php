...
<div class="container-fluid infoproducto">
	...
	<div class="container">
				...
				<?php
					...
					echo '<div class="comprarAhora" style="display:none">
						...
						if($infoproducto["oferta"] == 0){
							...
							<p class="subTotal'.$infoproducto["id"].' subtotales">
								...
								<strong>'.$divisa.' '.$signo.'$<span>'.$infoproducto["precio"].'</span></strong>
							...
							<p class="subTotal'.$infoproducto["id"].' subtotales">
								...
								<strong>'.$divisa.' '.$signo.'<span>'.$infoproducto["precioOferta"].'</span></strong>
					...
					if($infoproducto["precio"] == 0){
						...
						if($infoproducto["oferta"] == 0){
							...
							echo '<h2 class="text-muted">'.$divisa.' '.$signo.$infoproducto["precio"].'</h2>';
							...
							echo '<h2 class="text-muted">
								...
								<span>
									...
									<strong class="oferta">'.$divisa.' '.$signo.$infoproducto["precio"].'</strong>

								</span>

								<span>
									
									'.$signo.$infoproducto["precioOferta"].'
				...
				<?php
					...
					if($infoproducto["detalles"] != null){
						...
						if($infoproducto["tipo"] == "fisico"){
							...
							if(isset($detalles["Talla"])){
									//var_dump($detalles["Talla"]);
								...
								if($detalles["Talla"]!=null){
									echo '<div class="col-md-3 col-xs-12">
										...
										<select class="form-control seleccionarDetalle" id="seleccionarTalla">
											...
											foreach ($detalles["Talla"] as $key => $value) {
							...
							if(isset($detalles["tipo"])){
								...
								if($detalles["tipo"]!=null){
									
									echo '<div class="col-md-3 col-xs-12">

										<select class="form-control seleccionarDetalle" id="seleccionarTipo">
											
											<option value="">Tipo</option>';

											for($i = 0; $i < count($detalles["tipo"]); $i++){

												echo '<option value="'.$detalles["tipo"][$i].'">'.$detalles["tipo"][$i].'</option>';
							...
							if(isset($detalles["Capacidad"])){
								...
								if($detalles["Capacidad"] != null){

									echo '<div class="col-md-3 col-xs-12">

										<select class="form-control seleccionarDetalle" id="seleccionarCapacidad">
											
											<option value="">Capacidad</option>';

											for($i = 0; $i < count($detalles["Capacidad"]); $i++){

												echo '<option value="'.$detalles["Capacidad"][$i].'">'.$detalles["Capacidad"][$i].'</option>';
								...
								if($detalles["Color"]!=null){
									...
									echo '<div class="col-md-3 col-xs-12">
										...
										<select class="form-control seleccionarDetalle" id="seleccionarColor">
											...
											*/
											foreach ($detalles["Color"] as $key => $value) {
					...
					if($infoproducto["precio"]==0){
						...
						if($infoproducto["tipo"]=="virtual"){
							...
							echo '<div class="col-lg-4 col-md-4 col-xs-12">';
								...
								echo '<div class="input-group top-group">
									    <span class="input-group-btn">
									        <button type="button" class="btn btn-default btn-number1" data-type="minus" data-field="quant[1]">
									            <span class="glyphicon glyphicon-minus"></span>
									        </button>
									    </span>
									    <input type="text" name="quant[1]" class="form-control input-number1" value="1" min="1" max="150">
									    <span class="input-group-btn">
		...
		<div class="row">
			...
			$cantidad = 0;
			//var_dump(count($comentarios));

			foreach ($comentarios as $key => $value){
				//var_dump(count($value["id"]));
							...
							if($value["oferta"] != 0){
								...
								echo '<h2>
										...
										<small>
											...
											<strong class="oferta">'.$divisa.' '.$signo.$value["precio"].'</strong>

										</small>

										<small>'.$signo.$value["precioOferta"].'</small>
									
									</h2>';

							}else{

								echo '<h2><small>'.$divisa.' '.$signo.$value["precio"].'</small></h2>';
					...
					<div class="col-sm-6 col-xs-12 pull-right">
						...
						<table class="table table-striped tablaTasas">
							...
							<tbody>
								...
								<tr>
									<td>Subtotal</td>	
									<td><span class="cambioDivisa"><?php echo $divisa; ?></span> <?php echo $signo; ?><span class="valorSubtotal" valor="0">0</span></td>	
								</tr>

								<tr>
									<td>Envío</td>	
									<td><span class="cambioDivisa"><?php echo $divisa; ?></span> <?php echo $signo; ?><span class="valorTotalEnvio" valor="0">0</span></td>	
								</tr>

								<tr>
									<td>Impuesto</td>	
									<td><span class="cambioDivisa"><?php echo $divisa; ?></span> <?php echo $signo; ?><span class="valorTotalImpuesto" valor="0">0</span></td>	
								</tr>

								<tr>
									<td><strong>Total</strong></td>	
									<td><strong><span class="cambioDivisa"><?php echo $divisa; ?></span> <?php echo $signo; ?><span class="valorTotalCompra" valor="0">0</span></strong></td>	
								</tr>
