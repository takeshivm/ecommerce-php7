						...
						if($ofertas["oferta"] == 1){
							...
							<div class="textoBanner textoDer">
								...
								if($ofertas["precioOferta"] != 0){
									...
									echo '<h2 style="color:#fff"><strong>Todos los productos a '.$signo.' '.$ofertas["precioOferta"].'</strong></h2>';
							...
							if($finOferta == 0){
								...
								//ANTES ESTABA CON LA CLASE COL-LG-0
								//echo '<h3 class="col-lg-0" style="color:#fff">La oferta termina en '.$finOferta.' días</h3>';
								
								echo '<h3 class="col-lg" style="color:#fff">La oferta termina en '.$finOferta.' días</h3>';
						...
						if($ofertas[0]["oferta"] == 1){
							...
							<div class="textoBanner textoDer">
								...
								if($ofertas[0]["precioOferta"] != 0){
									...
									echo '<h2 style="color:#fff"><strong>Todos los productos a '.$signo.' '.$ofertas[0]["precioOferta"].'</strong></h2>';
