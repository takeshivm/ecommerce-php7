...
<head>
	...
	<!-- bootstrap tags input -->
  	<link rel="stylesheet" href="<?php echo $url; ?>vistas/plugins/tags/bootstrap-tagsinput.css">
	...
	<link rel="stylesheet" href="<?php echo $url; ?>vistas/css/pedido.css">

	<link rel="stylesheet" href="<?php echo $url; ?>vistas/css/mensajes.css">
	...
	<!--  	LIBRERIA PARA FORMAR ARCHIVOS PDF, Y CONSERVAR ESTILOS CSS	-->
	<script src="<?php echo $url; ?>vistas/js/plugins/html2canvas.js"></script>
	
	<script src="<?php echo $url; ?>vistas/js/plugins/jspdf.min.js"></script>

	<script src="https://apis.google.com/js/platform.js" async defer></script>

	<!-- bootstrap tags input https://bootstrap-tagsinput.github.io/bootstrap-tagsinput/examples/-->
  	<script src="<?php echo $url; ?>vistas/plugins/tags/bootstrap-tagsinput.min.js"></script>
...
if(isset($_GET["ruta"])){
	...
	}else if($rutas[0] == "buscador" || $rutas[0] == "verificar" || $rutas[0] == "salir" || $rutas[0] == "perfil" || $rutas[0] == "carrito-de-compras" || $rutas[0] == "error" || $rutas[0] == "finalizar-compra" || $rutas[0] == "curso" || $rutas[0] == "ofertas" || $rutas[0] == "pedido" || $rutas[0] == "disputa"){
...
<script src="<?php echo $url; ?>vistas/js/pedido.js"></script>
<script src="<?php echo $url; ?>vistas/js/mensajes.js"></script>
