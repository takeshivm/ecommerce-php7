...
class ControladorProductos{
	...
	static public function ctrMostrarDetalles($productoDetalle, $idDetalle, $nombreItem, $claveItem){

		$tabla = "productos";

		$respuesta = ModeloProductos::mdlMostrarDetalles($tabla, $productoDetalle, $idDetalle, $nombreItem, $claveItem);
