...
class ModeloUsuarios{
	...
	static public function mdlActualizarPerfil($tabla, $datos){
		...
		if (isset($datos["nombre"]) && $datos["nombre"] != "") {
			...
			$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET nombre = :nombre, email = :email, password = :password, foto = :foto, ciudad = :ciudad, region = :region, codigoPostal = :codigoPostal, domicilio = :domicilio, telefono = :telefono, tipo_documento = :tipo_documento, num_documento = :num_documento WHERE id = :id");
		...
		if (isset($datos["domicilio"]) && $datos["domicilio"] != "" && isset($datos["idUsuario"])) {
			# code...
			$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET ciudad = :ciudad, region = :region, codigoPostal = :codigoPostal, domicilio = :domicilio, telefono = :telefono WHERE id = :id");
