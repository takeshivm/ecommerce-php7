...
class ModeloProductos{
	...
	/*=============================================
	MOSTRAR DETALLES POR PORUCTO
	=============================================*/

	static public function mdlMostrarDetalles($tabla, $productoDetalle, $idDetalle, $nombreItem, $claveItem){

		$stmt = Conexion::conectar()->prepare("SELECT :$claveItem.nombre FROM $tabla p JOIN detalle_producto d on p.id = d.id_producto JOIN $nombreItem claveItem on $claveItem.id = d.id_$nombreItem
    		WHERE p.id = $idDetalle and d.stock > 0 GROUP by $claveItem.id");
